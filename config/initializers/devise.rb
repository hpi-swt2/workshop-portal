...
Devise.setup do |config|
  ...
  config.mailer_sender = Rails.configuration.from_address
  ...
  # The realm used in Http Basic Authentication. 'ApplicationLetter' by default.
  # config.http_authentication_realm = 'ApplicationLetter'
