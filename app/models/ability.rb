class Ability
  ...
  def initialize(user)
    ...
    if user.role? :organizer
      ...
      # Organizers can view, edit and print Applications, print participant badges, view participants for, view, upload and download materials for, print agreement letters for and manage Events
      can [:view_applicants, :edit_applicants, :view_participants, :print_applications, :print_badges, :manage, :view_material, :upload_material, :print_agreement_letters, :download_material], Event
      can :manage, Request
    end
    if user.role? :admin
      can :manage, :all
