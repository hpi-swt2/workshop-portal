class Ability
  ...
  def initialize(user)
    ...
    if user.role? :organizer
      ...
      can [:view_applicants, :edit_applicants, :view_participants, :print_applications, :print_badges, :manage, :view_material, :upload_material, :print_agreement_letters, :download_material, :view_unpublished], Event
