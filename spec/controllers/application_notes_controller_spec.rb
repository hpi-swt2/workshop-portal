  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ApplicationNote" do
        expect {
          post :create, params: {application_letter_id: application_letter.id, application_note: valid_attributes, session: valid_session}
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved application note as @application_note" do
        post :create, params: {application_letter_id: application_letter.id, application_note: invalid_attributes, session: valid_session}
