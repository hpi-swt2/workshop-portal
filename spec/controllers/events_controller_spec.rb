  ...
  context "With an existing event" do
    ...
    describe "GET #send_acceptances_email" do
      it "should assign a new email to accepted applications as @email" do
        ...
        expect(assigns(:email)).to have_attributes(hide_recipients: false, recipients: @event.email_adresses_of_pre_accepted_applicants, reply_to: 'workshop.portal@hpi.de', subject: '', content: '')
      end
    end
