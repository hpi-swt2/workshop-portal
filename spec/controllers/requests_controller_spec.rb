  ...
  context "with an existing request" do
    ...
    describe "GET #show" do
      it "assigns the requested request as @request" do
        get :show, params: {id: @a_request.to_param, session: valid_session}
    ...
    describe "GET #edit" do
      it "assigns the requested request as @request" do
        get :edit, params: {id: @a_request.to_param, session: valid_session}
        expect(assigns(:request)).to eq(@a_request)
      end
    end
    ...
    describe "GET #accept" do
      it "rejects the request for normal users" do
        get :accept, params: {id: @a_request.to_param, session: valid_session}
    ...
    describe "PUT #update" do
      context "with valid params" do
        ...
        it "updates the requested request" do
          put :update, params: {id: @a_request.to_param, request: new_attributes, session: valid_session}
          @a_request.reload
          expect(@a_request.topic_of_workshop).to eq(new_attributes[:topic_of_workshop])
        end

        it "assigns the requested request as @request" do
          put :update, params: {id: @a_request.to_param, request: valid_attributes, session: valid_session}
          expect(assigns(:request)).to eq(@a_request)
        end
      ...
      context "with invalid params" do
        it "assigns the request as @request" do
          put :update, params: {id: @a_request.to_param, request: invalid_attributes, session: valid_session}
          expect(assigns(:request)).to eq(@a_request)
        end
    ...
    describe "DELETE #destroy" do
      it "destroys the requested request" do
        ...
        expect {
          delete :destroy, params: {id: @a_request.to_param, session: valid_session}
    ...
    describe "PATCH #set_#{field}" do
      ...
      context "with valid params" do
        it "saves the #{field}" do
          ...
          data = {}
          data[field] = value
          patch path, params: {request_id: @a_request.to_param, request: data, session: valid_session}
          @a_request.reload
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "sends an email" do
        expect{ post :create, params: {request: valid_attributes, session: valid_session} }.to change{ ActionMailer::Base.deliveries.count }.by(1)
      end
    ...
    context "with invalid params" do
      ...
      it "does not send an email" do
        expect{ post :create, params: {request: invalid_attributes, session: valid_session} }.not_to change{ ActionMailer::Base.deliveries.count }
      end
